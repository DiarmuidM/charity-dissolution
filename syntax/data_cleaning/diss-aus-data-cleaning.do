...
sav $path3\iso_country_codes_20190919.dta, replace
...
compress
datasignature set
sav $path3\aus_webids_20190919.dta, replace	
...
desc, f
	...
	encode str_status, gen(dissolution)

	recode dissolution 1=0 9=1 2/7 10=2 8=3
	...
	*/
	...
	duplicates report cwid dissolution statusy
	duplicates list cwid dissolution statusy
	duplicates drop cwid dissolution statusy, force
	
	duplicates report cwid dissolution
	duplicates list cwid dissolution
	duplicates drop cwid dissolution, force
...
compress
datasignature set	
sav $path3\aus_revocation_20190921.dta, replace
...
count
	...
	** Operating countries
	...
	tab1 operating_countries*
		...
		preserve 
			use $path3\iso_country_codes_20190919.dta, clear
...
compress
datasignature set
sav $path3\aus_charreg_20190910.dta, replace
...
notes : This dataset provides a record of the 2014 AISs submitted by charities, that is, the ///
	...
	*/
	...
	/*
		Treat this similarly to 'dissolution'.
	*/
...
use $path3\aus_revocation_20190921.dta, clear
sort cwid
merge m:1 cwid using $path3\aus_webids_20190919.dta, keep(match master) keepus(ccnum)
drop _merge
...
use $path3\aus_charreg_20190910.dta, clear
sort ccnum
merge 1:1 ccnum using $path3\aus_revocation_20190921.dta, keep(match master)
drop _merge
...
rename _merge ar_merge
	...
	** Dependent variables
	...
	tab1 dissolution
	replace dissolution = 0 if dissolution==.
	
	gen deregistered = dissolution
	recode deregistered 0=0 1/4=1
	tab deregistered dissolution
	...
	** Age
	...
	tab1 dissolution statusy esty fin_year
	gen orgage = .
	replace orgage = 2020 - esty if dissolution==0 // for registered charities, their age is 2019 minus year established
	replace orgage = statusy - esty if dissolution > 0 // for deregistered charities, their age is removal year minue year established
	sum orgage, detail
...
compress
datasignature set, reset	
sav $path3\aus_charreg_analysis_20190910.dta, replace
